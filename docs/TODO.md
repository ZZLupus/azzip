...
| # | Feature | Why |
| :--- | :--- | :--- |
| 1 | **Custom app icon** | Replace default Tauri icon |
| 2 | **Installer packaging** | `.msi` / NSIS installer for distribution |

## Optional / Nice to Have

| # | Feature | Why |
| :--- | :--- | :--- |
| 3 | **Shell integration** | "Open with azzip" in Explorer context menu |
| 4 | **Multi-volume archives** | `.part1.rar` / `.zip.001` split archives |
| 5 | **Archive integrity check** | "Test archive" button to verify CRC/checksums |
